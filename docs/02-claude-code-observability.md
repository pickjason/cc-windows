...
```json
{ "pid": 90207, "cwd": "/Users/you/IdeaProjects/stylePrompt",
...
```json
{ "pid": 95259, "id": "601f830f", "cwd": "/Users/you", "kind": "background",
...
- `/Users/you/IdeaProjects/cc-window` → `-Users-you-IdeaProjects-cc-window`
- `/Users/you/.claude` → `-Users-you--claude`(点 → 横线,**双横线**)
...
- 本机实测(v2.1.177):`claude agents --json`、`claude --help`、`claude agents --help`、`~/.claude/projects/-Users-you-IdeaProjects-cc-window/*.jsonl`、`~/.claude/settings.json`、`~/.claude.json`
